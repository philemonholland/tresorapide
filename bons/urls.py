...
urlpatterns = [
    ...
    path("mobile/", views.MobileCaptureHomeView.as_view(), name="mobile-capture"),
    path("mobile/finalize/", views.MobileCaptureFinalizeView.as_view(), name="mobile-capture-finalize"),
    path("mobile/reset/", views.MobileCaptureResetView.as_view(), name="mobile-capture-reset"),
    ...
    path("<int:pk>/swap-signers/", views.BonSwapSignersView.as_view(), name="swap-signers"),
